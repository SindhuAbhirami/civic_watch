...
base_dataset_path = 'datasetv1' # <--- CHANGE THIS LINE!
...
best_model_path = os.path.join(MODEL_SAVE_DIR, f"disaster_model_v1.h5") # <--- Model name changed
...
final_model_save_path = os.path.join(MODEL_SAVE_DIR, f"disaster_model_v1.h5") # <--- Model name changed
